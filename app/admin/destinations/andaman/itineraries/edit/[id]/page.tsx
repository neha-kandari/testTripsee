...
const EditAndamanItineraryPage = () => {
  ...
  const fetchItinerary = async () => {
    try {
      const response = await fetch(`/api/admin/destinations/andaman/itineraries/${params.id}`);
      if (response.ok) {
    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Edit Andaman Itinerary</h1>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Andaman Island Paradise"
                />
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="text-xs text-gray-500 mb-2 bg-gray-100 p-2 rounded">
                Debug: {packages.length} packages loaded | API: /api/admin/packages?destination=andaman
              </div>
              ...
              {packagesLoading ? (
                ...
                <div className="text-sm text-red-600 bg-red-50 p-3 rounded-lg border border-red-200">
                  ...
                  <p>You must create packages for Andaman before creating itineraries.</p>
                  <Link
                    href="/admin/destinations/andaman/packages/new"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                    placeholder="e.g., Andaman Beach Resort"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                      placeholder="e.g., Arrival & Welcome to Andaman"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                      placeholder="e.g., Andaman Resort"
                    />
                  </div>
                    </div>
...
export default EditAndamanItineraryPage; 