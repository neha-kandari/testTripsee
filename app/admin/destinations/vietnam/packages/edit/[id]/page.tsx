  ...
  useEffect(() => {
    const fetchPackage = async () => {
      ...
      if (!packageId || packageId === 'undefined') {
        ...
        router.push('/admin/destinations/vietnam');
        return;
      }
    ...
    <AdminLayout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600 mt-2">Update package details for Vietnam</p>
        </div>
...
export default EditVietnamPackagePage; 