...
const NewDubaiItineraryPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const cleanedData = {
        ...formData,
        destination: 'dubai', // Always set destination to dubai for this page
    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Create New Dubai Itinerary</h1>
            <p className="text-gray-600 mt-2">Design a comprehensive travel itinerary for Dubai</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Dubai Luxury & Modern Adventure"
                />
              </div>
          ...
          <div className="flex justify-end space-x-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-blue-500 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-600 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
...
export default NewDubaiItineraryPage;
