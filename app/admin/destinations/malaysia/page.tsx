...
const MalaysiaAdminPage = () => {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      const response = await fetch(`/api/admin/destinations/malaysia/packages/${id}`, {
        method: 'DELETE',
      });
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Malaysia Packages</h1>
            <p className="text-gray-600 mt-2">Manage travel packages for Malaysia</p>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          {packages.length === 0 ? (
            <div className="p-8 text-center">
              ...
              <p className="text-gray-500 mb-6">Get started by creating your first Malaysia package</p>
              <Link
                href="/admin/destinations/malaysia/packages/new"
                ...
                <div key={packageData.id} className="p-6 hover:bg-gray-50 transition-colors duration-200">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <Link
                        href={`/admin/destinations/malaysia/packages/edit/${packageData.id}`}
...
export default MalaysiaAdminPage; 
