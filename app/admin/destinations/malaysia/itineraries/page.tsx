...
const MalaysiaItinerariesPage = () => {
  ...
  const fetchItineraries = async () => {
    try {
      ...
      console.error('Failed to fetch Malaysia itineraries:', error);
      setItineraries([]);
    } finally {
      setLoading(false);
    }
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      const response = await fetch(`/api/admin/destinations/malaysia/itineraries/${id}`, {
        method: 'DELETE',
      });
    ...
    return (
      <AdminLayout>
        <div className="flex items-center justify-center h-64">
          <div className="text-gray-500">Loading Malaysia itineraries...</div>
        </div>
      </AdminLayout>
    );
  }
    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Malaysia Itineraries</h1>
            <p className="text-gray-600 mt-2">Manage travel itineraries for Malaysia</p>
          </div>
          <Link
            href="/admin/destinations/malaysia/itineraries/new"
        ...
        {itineraries.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">Create your first Malaysia itinerary to get started</p>
            <Link
              href="/admin/destinations/malaysia/itineraries/new"
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex space-x-2">
                      <Link
                        href={`/admin/destinations/malaysia/itineraries/edit/${itinerary.id}`}
...
export default MalaysiaItinerariesPage; 