...
const EditThailandItineraryPage = () => {
  ...
  const fetchItinerary = async () => {
    try {
      const response = await fetch(`/api/admin/destinations/thailand/itineraries/${params.id}`);
      if (response.ok) {
    ...
    <AdminLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Edit Thailand Itinerary</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Thailand Cultural Heritage Tour"
                />
              </div>
            ...
            <div className="mt-6">
              ...
              {packages.length === 0 ? (
                <div className="text-sm text-red-600 bg-red-50 p-3 rounded-lg border border-red-200">
                  ...
                  <p>You must create packages for Thailand before creating itineraries.</p>
                  <Link
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    const selectedPackage = packages.find((pkg: Package) => pkg.id === selectedPackageId);
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                    placeholder="e.g., Bangkok Grand Hotel"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setItinerary(prev => prev ? { ...prev, hotelRating: e.target.value } : null)}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                      placeholder="e.g., Arrival & Welcome to Bangkok"
                    />
                  </div>
...
export default EditThailandItineraryPage; 