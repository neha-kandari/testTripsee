      ...
      <div className="relative z-10 max-w-lg w-full text-center">
        ...
        <div className="flex justify-center mb-12 relative z-20">
          ...
          >
            ...
            <span className="absolute inset-0 w-full h-full rounded-full border-4 border-green-500 animate-ping opacity-30"></span>
            
            <svg className="w-6 h-6 flex-shrink-0 animate-bounce" fill="currentColor" viewBox="0 0 24 24">
