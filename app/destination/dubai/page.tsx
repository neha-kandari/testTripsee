...
const HERO_IMAGE = "https://res.cloudinary.com/djmx4c5jq/image/upload/q_auto,f_auto,w_1920,c_limit/v1782838413/Destination/DubaiHero/Burj%20Khalifa.webp";

export default async function Page() {
  const initialPackages = await getDestinationPackages('dubai');
  return (
    <>
