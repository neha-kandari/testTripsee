...
const HERO_IMAGE = "https://res.cloudinary.com/djmx4c5jq/image/upload/q_auto,f_auto,w_1920,c_limit/v1782838458/Destination/MaldivesHero/gulhi-falhu.webp";

export default async function Page() {
  const initialPackages = await getDestinationPackages('maldives');
  return (
    <>
